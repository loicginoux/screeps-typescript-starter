...
RoomPosition.prototype.isPassible = function (ignoreCreeps: boolean = false): boolean {
  // Is terrain passable?
...
RoomPosition.prototype.availableNeighbors = function (ignoreCreeps: boolean = false): RoomPosition[] {
